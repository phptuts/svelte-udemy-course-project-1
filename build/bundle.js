    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div10 = element("div");
    			div1 = element("div");
    			div1.innerHTML = `<div class="column"><h1 class="svelte-fblhrz">Tip Calculator</h1></div>`;
    			t1 = space();
    			div3 = element("div");
    			div2 = element("div");
    			label0 = element("label");
    			label0.textContent = "Meal Price";
    			t3 = space();
    			...
    			t17 = text(/*calculatedTip*/ ctx[2]);
    			attr(div1, "class", "row");
    			attr(label0, "for", "price");
    			attr(input0, "type", "number");
    			attr(input0, "id", "price");
    			attr(input0, "placeholder", "Total");
    			attr(input0, "min", "0");
    			attr(label1, "for", "tip");
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*calculatedTip*/ 4) set_data(t17, /*calculatedTip*/ ctx[2]);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*price, tip*/ 3) {
    			 $$invalidate(2, calculatedTip = calculatTip(price, tip));
    		}
    	};
